...
query = f"""
    with unike_stillingsannonser as (
        select
            ...
            antall_stillinger,
            stillingskategori,
            format_datetime('%Y-%m-%d', datetime(timestamp_micros(cast(opprettet_tidspunkt / 1000 as int64)))) as tidspunkt_kandidatliste_opprettet_yearmonthday
    ...
    tidspunkt_kandidatliste_opprettet_yearmonthday,
    case
    ...
    where tidspunkt_kandidatliste_opprettet_yearmonthday >= '2020-01-01'
    group by justert_kategori, tidspunkt_kandidatliste_opprettet_yearmonthday;
    """
df_antall_stillinger_per_kategori = bq_client.query(query=query).to_dataframe().set_index('tidspunkt_kandidatliste_opprettet_yearmonthday')
```
...
fig = go.Figure(
    data=[
        go.Bar(
            ...
            y=andel_vist_kontaktinfo_med_hull_i_CV.antall_stillinger,
            marker_color=colors,
        )
    ]
)
...
fig = go.Figure(
    data=[
        go.Bar(
            ...
            y=andel_vist_kontaktinfo_under_30.antall_stillinger,
            marker_color=colors,
        )
    ]
)
...
fig = go.Figure(
    data=[
        go.Bar(
            ...
            y=andel_vist_kontaktinfo_50_eller_eldre.antall_stillinger,
            marker_color=colors,
        )
    ]
)
...
fig = go.Figure(
    data=[
        go.Bar(
            ...
            y=andel_vist_kontaktinfo_med_innsatsbehov.antall_stillinger,
            marker_color=colors,
        )
    ]
)
