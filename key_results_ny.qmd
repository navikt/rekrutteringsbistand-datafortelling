...
```{python}
query = f"""
    select count(distinct stilling_id) as antall_stillingsannonser from `rekrutteringsbistand_statistikk_pg15.visning_kontaktinfo` as visning_kontaktinfo
...
query = f"""
    with presentert_utfall as (
        ...
        inner join `rekrutteringsbistand_kandidat_pg15.veilkandidat` k on k.aktor_id = kandidatutfall.aktorid
        inner join `rekrutteringsbistand_kandidat_pg15.utfallsendring` u on u.veilkandidat_db_id = k.db_id
...
query = f"""
    ...
    count(distinct stillings_id) as antall_stillingsannonser
...
query = f"""
    ...
    select 
        format_datetime('%Y-%m', kandidatliste.stilling_opprettet_tidspunkt) as tidspunkt_stilling_opprettet_yearmonth,
        count(distinct kandidatliste_id) as antall_stillingsannonser
    from`rekrutteringsbistand_statistikk_pg15.kandidatliste` as kandidatliste
                inner join faatt_jobben_utfall
                on faatt_jobben_utfall.kandidatlisteid = kandidatliste.kandidatliste_id
                inner join `rekrutteringsbistand_statistikk_pg15.stilling` as stilling
...
query = f"""
    ...
    order by tidspunkt_faatt_jobben_yearmonthday;
    """
df_antall_kandidatlister_der_minst_en_kandidat_med_hull_i_CV_fikk_jobben = bq_client.query(query=query).to_dataframe().set_index('tidspunkt_faatt_jobben_yearmonthday')
```
```{python}
query = f"""
    with id_siste_utfall_per_kandidat_per_liste as (
    ...
    order by tidspunkt_faatt_jobben_yearmonthday;
    """
df_antall_kandidatlister_der_minst_en_kandidat_under_30_fikk_jobben = bq_client.query(query=query).to_dataframe().set_index('tidspunkt_faatt_jobben_yearmonthday')
```
```{python}
query = f"""
    with id_siste_utfall_per_kandidat_per_liste as (
    ...
    order by tidspunkt_faatt_jobben_yearmonthday;
    """
df_antall_kandidatlister_der_minst_en_kandidat_50_eller_eldre_fikk_jobben = bq_client.query(query=query).to_dataframe().set_index('tidspunkt_faatt_jobben_yearmonthday')
```
```{python}
query = f"""
    with id_siste_utfall_per_kandidat_per_liste as (
    ...
    order by tidspunkt_faatt_jobben_yearmonthday;
    """
df_antall_kandidatlister_der_minst_en_kandidat_med_innsatsbehov_fikk_jobben = bq_client.query(query=query).to_dataframe().set_index('tidspunkt_faatt_jobben_yearmonthday')
```
...
```{python}
query = f"""
    with unike_stillingsannonser as (
        select
            distinct stilling_id,
            antall_stillinger,
            stillingskategori,
            format_datetime('%Y-%m', datetime(timestamp_micros(cast(opprettet_tidspunkt / 1000 as int64)))) as tidspunkt_kandidatliste_opprettet_yearmonth
        from `rekrutteringsbistand_kandidat_pg15_pg15.veilkandliste`
        where stilling_id is not null
    )
    select
    sum(antall_stillinger) as totalt_antall_stillinger,
    tidspunkt_kandidatliste_opprettet_yearmonth,
    case
        when stillingskategori is null or stillingskategori = 'STILLING' then 'STILLING'
        else stillingskategori
    end as justert_kategori
    from unike_stillingsannonser
    where tidspunkt_kandidatliste_opprettet_yearmonth >= '2020-01'
    group by justert_kategori, tidspunkt_kandidatliste_opprettet_yearmonth;
    """
df_antall_stillinger_per_kategori = bq_client.query(query=query).to_dataframe().set_index('tidspunkt_kandidatliste_opprettet_yearmonth')
```
...
De ulike innsatsbehov-gruppene som brukes i disse målingene her er: 
...
## Row
```{python}
#| title: Andel der minst én kandidat i prioritert målgruppe fikk vist sin kontaktinfo per måned
...
colors = ['#0d6efd',] * len(andel_vist_kontaktinfo_prioritert_målgruppe.index)
...
fig = go.Figure(
    data=[
        go.Bar(
            ...
            y=andel_vist_kontaktinfo_prioritert_målgruppe.antall_stillingsannonser,
            marker_color=colors,
        )
    ]
)
...
```
```{python}
#| title: Andel der minst én kandidat med hull i CV fikk vist sin kontaktinfo per måned
andel_vist_kontaktinfo_med_hull_i_CV = df_antall_kandidatlister_med_minst_en_kandidat_med_hull_i_cv_som_har_faatt_vist_sin_kontaktinfo_per_maaned / df_antall_kandidatlister_tilknyttet_stilling_per_maaned

colors = ['#0d6efd',] * len(andel_vist_kontaktinfo_med_hull_i_CV.index)
colors[-2] = 'lightslategray'
colors[-1] = 'lightslategray'
...
fig = go.Figure(
    data=[
        go.Bar(
            x=andel_vist_kontaktinfo_med_hull_i_CV.index,
            y=andel_vist_kontaktinfo_med_hull_i_CV.antall_stillingsannonser,
            marker_color=colors,
        )
    ]
)
...
```{python}
#| title: Andel der minst én kandidat under 30 år fikk vist sin kontaktinfo per måned
andel_vist_kontaktinfo_under_30 = df_antall_kandidatlister_med_minst_en_kandidat_under_30_som_har_faatt_vist_sin_kontaktinfo_per_maaned / df_antall_kandidatlister_tilknyttet_stilling_per_maaned

colors = ['#0d6efd',] * len(andel_vist_kontaktinfo_under_30.index)
colors[-2] = 'lightslategray'
colors[-1] = 'lightslategray'
...
fig = go.Figure(
    data=[
        go.Bar(
            x=andel_vist_kontaktinfo_under_30.index,
            y=andel_vist_kontaktinfo_under_30.antall_stillingsannonser,
            marker_color=colors,
        )
    ]
)
...
```
```{python}
#| title: Andel der minst én kandidat 50 år eller eldre fikk vist sin kontaktinfo per måned
andel_vist_kontaktinfo_50_eller_eldre = df_antall_kandidatlister_med_minst_en_kandidat_50_eller_eldre_som_har_faatt_vist_sin_kontaktinfo_per_maaned / df_antall_kandidatlister_tilknyttet_stilling_per_maaned

colors = ['#0d6efd',] * len(andel_vist_kontaktinfo_50_eller_eldre.index)
colors[-2] = 'lightslategray'
colors[-1] = 'lightslategray'
...
fig = go.Figure(
    data=[
        go.Bar(
            x=andel_vist_kontaktinfo_50_eller_eldre.index,
            y=andel_vist_kontaktinfo_50_eller_eldre.antall_stillingsannonser,
            marker_color=colors,
        )
    ]
)
...
```{python}
#| title: Andel der minst én kandidat med innsatsbehov fikk vist sin kontaktinfo per måned
andel_vist_kontaktinfo_med_innsatsbehov = df_antall_kandidatlister_med_minst_en_kandidat_med_innsatsbehov_som_har_faatt_vist_sin_kontaktinfo_per_maaned / df_antall_kandidatlister_tilknyttet_stilling_per_maaned

colors = ['#0d6efd',] * len(andel_vist_kontaktinfo_med_innsatsbehov.index)
colors[-2] = 'lightslategray'
colors[-1] = 'lightslategray'
...
fig = go.Figure(
    data=[
        go.Bar(
            x=andel_vist_kontaktinfo_med_innsatsbehov.index,
            y=andel_vist_kontaktinfo_med_innsatsbehov.antall_stillingsannonser,
            marker_color=colors,
        )
    ]
)
...
colors = ['#ffc107',] * len(andel_stillinger_hvor_minst_en_i_prioritert_målgruppe_fikk_jobben.index)
...
fig = go.Figure(
    data=[
        go.Bar(
            ...
            y=andel_stillinger_hvor_minst_en_i_prioritert_målgruppe_fikk_jobben.antall_stillingsannonser,
            marker_color=colors,
        )
    ]
)
...
colors = ['#ffc107',] * len(andel_stillinger_hvor_minst_en_med_hull_i_CV_fikk_jobben.index)
colors[-3] = 'lightslategray'
colors[-2] = 'lightslategray'
colors[-1] = 'lightslategray'
...
fig = go.Figure(
    data=[
        go.Bar(
            ...
            y=andel_stillinger_hvor_minst_en_med_hull_i_CV_fikk_jobben.antall_stillingsannonser,
            marker_color=colors,
        )
    ]
)
...
colors = ['#ffc107',] * len(andel_stillinger_hvor_minst_en_under_30_fikk_jobben.index)
colors[-3] = 'lightslategray'
colors[-2] = 'lightslategray'
colors[-1] = 'lightslategray'
...
fig = go.Figure(
    data=[
        go.Bar(
            ...
            y=andel_stillinger_hvor_minst_en_under_30_fikk_jobben.antall_stillingsannonser,
            marker_color=colors,
        )
    ]
)
...
colors = ['#ffc107',] * len(andel_stillinger_hvor_minst_en_50_eller_eldre_fikk_jobben.index)
colors[-3] = 'lightslategray'
colors[-2] = 'lightslategray'
colors[-1] = 'lightslategray'
...
fig = go.Figure(
    data=[
        go.Bar(
            ...
            y=andel_stillinger_hvor_minst_en_50_eller_eldre_fikk_jobben.antall_stillingsannonser,
            marker_color=colors,
        )
    ]
)
...
colors = ['#ffc107',] * len(andel_stillinger_hvor_minst_en_med_innsatsbehov_fikk_jobben.index)
colors[-3] = 'lightslategray'
colors[-2] = 'lightslategray'
colors[-1] = 'lightslategray'
...
fig = go.Figure(
    data=[
        go.Bar(
            ...
            y=andel_stillinger_hvor_minst_en_med_innsatsbehov_fikk_jobben.antall_stillingsannonser,
            marker_color=colors,
        )
    ]
)
...
colors = ['#6c757d',] * len(andel_direktemeldte_stillinger_med_minst_en_presentert_kandidat.index)
colors[-3] = 'crimson'
colors[-2] = 'crimson'
colors[-1] = 'crimson'
...
fig = go.Figure(
    data=[
        go.Bar(
            ...
            y=andel_direktemeldte_stillinger_med_minst_en_presentert_kandidat.antall_stillingsannonser,
            marker_color=colors,
        )
    ]
)
...
colors = ['#0d6efd',] * len(df_antall_kandidatlister_med_minst_en_kandidat_i_prioritert_maalgruppe_som_har_faatt_vist_sin_kontaktinfo_per_maaned.index)
colors[-2] = 'lightslategray'
colors[-1] = 'lightslategray'
...
fig = go.Figure(
    data=[
        go.Bar(
            ...
            y=df_antall_kandidatlister_med_minst_en_kandidat_i_prioritert_maalgruppe_som_har_faatt_vist_sin_kontaktinfo_per_maaned.antall_stillingsannonser,
            marker_color=colors,
        )
    ]
)
...
colors = ['#0d6efd',] * len(df_antall_kandidatlister_med_minst_en_kandidat_med_hull_i_cv_som_har_faatt_vist_sin_kontaktinfo_per_maaned.index)
colors[-2] = 'lightslategray'
colors[-1] = 'lightslategray'
...
fig = go.Figure(
    data=[
        go.Bar(
            ...
            y=df_antall_kandidatlister_med_minst_en_kandidat_med_hull_i_cv_som_har_faatt_vist_sin_kontaktinfo_per_maaned.antall_stillingsannonser,
            marker_color=colors,
        )
    ]
)
...
colors = ['#0d6efd',] * len(df_antall_kandidatlister_med_minst_en_kandidat_under_30_som_har_faatt_vist_sin_kontaktinfo_per_maaned.index)
colors[-2] = 'lightslategray'
colors[-1] = 'lightslategray'
...
fig = go.Figure(
    data=[
        go.Bar(
            ...
            y=df_antall_kandidatlister_med_minst_en_kandidat_under_30_som_har_faatt_vist_sin_kontaktinfo_per_maaned.antall_stillingsannonser,
            marker_color=colors,
        )
    ]
)
...
colors = ['#0d6efd',] * len(df_antall_kandidatlister_med_minst_en_kandidat_50_eller_eldre_som_har_faatt_vist_sin_kontaktinfo_per_maaned.index)
colors[-2] = 'lightslategray'
colors[-1] = 'lightslategray'
...
fig = go.Figure(
    data=[
        go.Bar(
            ...
            y=df_antall_kandidatlister_med_minst_en_kandidat_50_eller_eldre_som_har_faatt_vist_sin_kontaktinfo_per_maaned.antall_stillingsannonser,
            marker_color=colors,
        )
    ]
)
...
colors = ['#0d6efd',] * len(df_antall_kandidatlister_med_minst_en_kandidat_med_innsatsbehov_som_har_faatt_vist_sin_kontaktinfo_per_maaned.index)
colors[-2] = 'lightslategray'
colors[-1] = 'lightslategray'
...
fig = go.Figure(
    data=[
        go.Bar(
            ...
            y=df_antall_kandidatlister_med_minst_en_kandidat_med_innsatsbehov_som_har_faatt_vist_sin_kontaktinfo_per_maaned.antall_stillingsannonser,
            marker_color=colors,
        )
    ]
)
...
colors = ['#ffc107',] * len(df_antall_kandidatlister_der_minst_en_kandidat_i_prioritert_maalgruppe_fikk_jobben_per_maaned.index)
colors[-3] = 'lightslategray'
colors[-2] = 'lightslategray'
colors[-1] = 'lightslategray'
...
fig = go.Figure(
    data=[
        go.Bar(
            ...
            y=df_antall_kandidatlister_der_minst_en_kandidat_i_prioritert_maalgruppe_fikk_jobben_per_maaned.antall_stillingsannonser,
            marker_color=colors,
        )
    ]
)
...
colors = ['#ffc107',] * len(df_antall_kandidatlister_der_minst_en_kandidat_med_hull_i_CV_fikk_jobben_per_maaned.index)
colors[-3] = 'lightslategray'
colors[-2] = 'lightslategray'
colors[-1] = 'lightslategray'
...
fig = go.Figure(
    data=[
        go.Bar(
            ...
            y=df_antall_kandidatlister_der_minst_en_kandidat_med_hull_i_CV_fikk_jobben_per_maaned.antall_stillingsannonser,
            marker_color=colors,
        )
    ]
)
...
colors = ['#ffc107',] * len(df_antall_kandidatlister_der_minst_en_kandidat_under_30_fikk_jobben_per_maaned.index)
colors[-3] = 'lightslategray'
colors[-2] = 'lightslategray'
colors[-1] = 'lightslategray'
...
fig = go.Figure(
    data=[
        go.Bar(
            ...
            y=df_antall_kandidatlister_der_minst_en_kandidat_under_30_fikk_jobben_per_maaned.antall_stillingsannonser,
            marker_color=colors,
        )
    ]
)
...
colors = ['#ffc107',] * len(df_antall_kandidatlister_der_minst_en_kandidat_50_eller_eldre_fikk_jobben_per_maaned.index)
colors[-3] = 'lightslategray'
colors[-2] = 'lightslategray'
colors[-1] = 'lightslategray'
...
fig = go.Figure(
    data=[
        go.Bar(
            ...
            y=df_antall_kandidatlister_der_minst_en_kandidat_50_eller_eldre_fikk_jobben_per_maaned.antall_stillingsannonser,
            marker_color=colors,
        )
    ]
)
...
colors = ['#ffc107',] * len(df_antall_kandidatlister_der_minst_en_kandidat_med_innsatsbehov_fikk_jobben_per_maaned.index)
colors[-3] = 'lightslategray'
colors[-2] = 'lightslategray'
colors[-1] = 'lightslategray'
...
fig = go.Figure(
    data=[
        go.Bar(
            ...
            y=df_antall_kandidatlister_der_minst_en_kandidat_med_innsatsbehov_fikk_jobben_per_maaned.antall_stillingsannonser,
            marker_color=colors,
        )
    ]
)
...
fig = go.Figure(
    data=[
        go.Bar(
            ...
            y=df_antall_direktemeldte_stillinger_med_minst_en_presentert_kandidat_per_maaned.antall_stillingsannonser,
            marker_color=colors,
        )
    ]
)
...
fig = go.Figure(
    data=[
        go.Bar(
            ...
            y=df_antall_kandidatlister_tilknyttet_stilling_per_maaned.antall_stillingsannonser,
            marker_color=colors,
        )
    ]
)
...
fig = go.Figure(
    data=[
        go.Bar(
            ...
            y=df_antall_kandidatlister_tilknyttet_direktemeldt_stilling_per_maaned.antall_stillingsannonser,
            marker_color=colors,
        )
    ]
)
...
colors = ['#0d6efd',] * len(df_antall_kandidatlister_med_minst_en_kandidat_i_prioritert_maalgruppe_som_har_faatt_vist_sin_kontaktinfo.index[-3:])
...
colors = ['#ffc107',] * len(df_antall_kandidatlister_der_minst_en_kandidat_i_prioritert_maalgruppe_fikk_jobben.index[-3:])
...
colors = ['#6c757d',] * len(df_antall_direktemeldte_stillinger_med_minst_en_presentert_kandidat.index[-3:])
...
## Row
```{python}
#| title: Antall der minst én med hull i CV'en fikk vist sin kontaktinfo

colors = ['#0d6efd',] * len(df_antall_kandidatlister_med_minst_en_kandidat_med_hull_i_CV_som_har_faatt_vist_sin_kontaktinfo.index[-3:])

fig = go.Figure(
    data=[
        go.Bar(
            x=df_antall_kandidatlister_med_minst_en_kandidat_med_hull_i_CV_som_har_faatt_vist_sin_kontaktinfo.index[-3:],
            y=df_antall_kandidatlister_med_minst_en_kandidat_med_hull_i_CV_som_har_faatt_vist_sin_kontaktinfo.f0_[-3:],
            marker_color=colors,
        )
    ]
)
...
```
```{python}
#| title: Antall der minst én under 30 år fikk vist sin kontaktinfo

colors = ['#0d6efd',] * len(df_antall_kandidatlister_med_minst_en_kandidat_under_30_som_har_faatt_vist_sin_kontaktinfo.index[-3:])

fig = go.Figure(
    data=[
        go.Bar(
            x=df_antall_kandidatlister_med_minst_en_kandidat_under_30_som_har_faatt_vist_sin_kontaktinfo.index[-3:],
            y=df_antall_kandidatlister_med_minst_en_kandidat_under_30_som_har_faatt_vist_sin_kontaktinfo.f0_[-3:],
            marker_color=colors,
        )
    ]
)
...
```
```{python}
#| title: Antall der minst én som er 50 år eller eldre fikk vist sin kontaktinfo

colors = ['#0d6efd',] * len(df_antall_kandidatlister_med_minst_en_kandidat_50_eller_eldre_som_har_faatt_vist_sin_kontaktinfo.index[-3:])

fig = go.Figure(
    data=[
        go.Bar(
            x=df_antall_kandidatlister_med_minst_en_kandidat_50_eller_eldre_som_har_faatt_vist_sin_kontaktinfo.index[-3:],
            y=df_antall_kandidatlister_med_minst_en_kandidat_50_eller_eldre_som_har_faatt_vist_sin_kontaktinfo.f0_[-3:],
            marker_color=colors,
        )
    ]
)
...
```
```{python}
#| title: Antall der minst én med innsatsbehov fikk vist sin kontaktinfo

colors = ['#0d6efd',] * len(df_antall_kandidatlister_med_minst_en_kandidat_med_innsatsbehov_som_har_faatt_vist_sin_kontaktinfo.index[-3:])

fig = go.Figure(
    data=[
        go.Bar(
            x=df_antall_kandidatlister_med_minst_en_kandidat_med_innsatsbehov_som_har_faatt_vist_sin_kontaktinfo.index[-3:],
            y=df_antall_kandidatlister_med_minst_en_kandidat_med_innsatsbehov_som_har_faatt_vist_sin_kontaktinfo.f0_[-3:],
            marker_color=colors,
        )
    ]
)
...
## Row
```{python}
#| title: Antall der kandidater med hull i CV fikk jobben

colors = ['#ffc107',] * len(df_antall_kandidatlister_der_minst_en_kandidat_med_hull_i_CV_fikk_jobben.index[-3:])

fig = go.Figure(
    data=[
        go.Bar(
            x=df_antall_kandidatlister_der_minst_en_kandidat_med_hull_i_CV_fikk_jobben.index[-3:],
            y=df_antall_kandidatlister_der_minst_en_kandidat_med_hull_i_CV_fikk_jobben.f0_[-3:],
            marker_color=colors,
        )
    ]
)
...
```
```{python}
#| title: Antall der kandidater under 30 år fikk jobben

colors = ['#ffc107',] * len(df_antall_kandidatlister_der_minst_en_kandidat_under_30_fikk_jobben.index[-3:])

fig = go.Figure(
    data=[
        go.Bar(
            x=df_antall_kandidatlister_der_minst_en_kandidat_under_30_fikk_jobben.index[-3:],
            y=df_antall_kandidatlister_der_minst_en_kandidat_under_30_fikk_jobben.f0_[-3:],
            marker_color=colors,
        )
    ]
)
...
```
```{python}
#| title: Antall der kandidater som er 50 år eller eldre fikk jobben

colors = ['#ffc107',] * len(df_antall_kandidatlister_der_minst_en_kandidat_50_eller_eldre_fikk_jobben.index[-3:])

fig = go.Figure(
    data=[
        go.Bar(
            x=df_antall_kandidatlister_der_minst_en_kandidat_50_eller_eldre_fikk_jobben.index[-3:],
            y=df_antall_kandidatlister_der_minst_en_kandidat_50_eller_eldre_fikk_jobben.f0_[-3:],
            marker_color=colors,
        )
    ]
)
...
```
```{python}
#| title: Antall der kandidater med innsatsbehov fikk jobben

colors = ['#ffc107',] * len(df_antall_kandidatlister_der_minst_en_kandidat_med_innsatsbehov_fikk_jobben.index[-3:])

fig = go.Figure(
    data=[
        go.Bar(
            x=df_antall_kandidatlister_der_minst_en_kandidat_med_innsatsbehov_fikk_jobben.index[-3:],
            y=df_antall_kandidatlister_der_minst_en_kandidat_med_innsatsbehov_fikk_jobben.f0_[-3:],
            marker_color=colors,
        )
    ]
)
