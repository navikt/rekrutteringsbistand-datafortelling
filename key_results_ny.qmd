...
query = f"""
    with presentert_utfall as (
        ...
        inner join `rekrutteringsbistand_kandidat.veilkandidat` k on k.aktor_id = kandidatutfall.aktorid
        inner join `rekrutteringsbistand_kandidat.utfallsendring` u on u.veilkandidat_db_id = k.db_id
