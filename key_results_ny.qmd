...
colors = ['lightslategray',] * len(df_antall_kandidatlister_der_minst_en_kandidat_med_hull_i_CV_fikk_jobben.index[-3:])
...
colors = ['lightslategray',] * len(df_antall_kandidatlister_der_minst_en_kandidat_under_30_fikk_jobben.index[-3:])
...
colors = ['lightslategray',] * len(df_antall_kandidatlister_der_minst_en_kandidat_50_eller_eldre_fikk_jobben.index[-3:])
...
colors = ['lightslategray',] * len(df_antall_kandidatlister_der_minst_en_kandidat_med_innsatsbehov_fikk_jobben.index[-3:])
